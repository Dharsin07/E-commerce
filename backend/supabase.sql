...
-- =====================================================
-- 9. CART_ITEMS TABLE (SIMPLE WORKING VERSION)
-- =====================================================
-- Step 1: Drop the broken table completely
DROP TABLE IF EXISTS cart_items CASCADE;

-- Step 2: Create cart_items table with all required columns and foreign key
...
-- Step 4: Disable RLS (since using anon key)
