...
-- Disable RLS for cart_items table (Firebase compatibility)
...
-- Disable RLS for reviews table (Firebase compatibility)
...
-- Ensure featured column exists (for existing tables)
ALTER TABLE public.products 
ADD COLUMN IF NOT EXISTS featured BOOLEAN DEFAULT false;

-- Update existing products to have correct featured values
UPDATE public.products 
SET featured = CASE 
  WHEN slug IN ('modern-sofa', 'oak-dining-table', 'coffee-table', 'dining-chairs') 
  THEN true 
  ELSE false 
END
...
-- Disable RLS for products table to allow CRUD operations
ALTER TABLE public.products DISABLE ROW LEVEL SECURITY;
